                            ...
                            <table class="table table-bordered table-invoice">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="span12" id="cAddress" value="<%=ViewData["cAddress"] %>"  name="cAddress">
                                        </td>
                                         <td class="tright">Số điện thoại: <span class="f-red">(*)</span> :
                                        </td>
                                        <td>
                                            <input type="text" class="span12" id="cPhone" value="<%=ViewData["cPhone"] %>"  name="cPhone">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="span12" id="cNameFace" value="<%=ViewData["cNameFace"] %>"  name="cNameFace">
                                        </td>
                                         <td class="tright">Link: <span class="f-red">(*)</span> :
                                        </td>
                                        <td>
                                            <input type="text" class="span12" id="cLinkFace" value="<%=ViewData["cLinkFace"] %>"  name="cLinkFace">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="span12" id="cCardBank" value="<%=ViewData["cCardBank"] %>"  name="cCardBank">
                                        </td>
                                    </tr>
                                     <tr>
...
<script type="text/javascript">
    function CapNhat() {
        $.ajax({
            type: "post",
            url: "<%=ResolveUrl("~")%>employee/update",
