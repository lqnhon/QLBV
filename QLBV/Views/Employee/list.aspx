...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current">Nhân viên</a></div>
    <div class="row-fluid">
        <div class="span12">
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <span style="float: right;" class="btn btn-success" onclick="ShowPopUp('','/employee/add')"><i class="icon-plus"></i>&nbsp;Thêm mới&nbsp;</span>
                </div>
