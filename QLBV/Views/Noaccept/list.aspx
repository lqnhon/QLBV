...
<div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current">Bài viết không được duyệt</a></div>
    <div class="row-fluid">
        <div class="span12">
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Danh sách bài viết không được duyệt</h5>
                </div>
    ...
    '<div id="load3" class="spin"></div><div id="load4" class="spin"></div><div id="load5" class="spin"></div></div></div>');
            $.post("/noaccept/search", "key=" + $("#key").val(), function (data) {
                $("#list").html(data);
                $("#screen").hide().remove();
            });
        }
