...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Danh sách bài viết đã duyệt
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current">Bài viết đã duyệt</a></div>
    <div class="row-fluid">
        <div class="span12">
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Danh sách bài viết đã duyệt</h5>
                </div>
    ...
    '<div id="load3" class="spin"></div><div id="load4" class="spin"></div><div id="load5" class="spin"></div></div></div>');
            $.post("/accepted/search", "key=" + $("#key").val(), function (data) {
                $("#list").html(data);
                $("#screen").hide().remove();
            });
        }
