...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current">Cập nhật bài viết</a></div>
                    ...
                    <table class="table table-bordered table-invoice">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 85%">
                                    <input type="text" class="span12" id="cTopic" name="cTopic" value="<%=ViewData["cTopic"] %>" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 15%">Mô tả:</td>
                                <td style="width: 85%">
                                    <textarea id="cDescribe" name="cDescribe" class="span12" ><%=ViewData["cDescribe"] %></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="cContent" name="cContent" class="span12"><%=ViewData["cContent"] %></textarea>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 85%">
                                    <input type="text" class="span12" id="cKey" name="cKey" value="<%=ViewData["cKey"] %>" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tright" colspan="4">
                                    ...
                                    <input type="submit" class="btn btn-primary" onclick="ChosenSave(1)" value="Lưu"/>
