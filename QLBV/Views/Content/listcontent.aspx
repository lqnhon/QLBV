...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   Xử lý bài viết của nhân viên <%=ViewData["cName"] %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current">  Danh sách bài viết đang chờ xử lý của nhân viên <%=ViewData["cName"] %></a></div>
    <div class="row-fluid">
        <div class="span12">
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5> Danh sách bài viết đang chờ xử của nhân viên <%=ViewData["cName"] %></h5>
                </div>
